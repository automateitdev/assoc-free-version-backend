...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    protected function setSuccessUrl()
    {
        ...
        $this->successUrl = rtrim(config('app.frontend')) . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim(config('app.frontend')) . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = rtrim(config('app.frontend')) . $this->config['cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim(config('app.frontend')) . $this->config['ipn_url'];
    }
    ...
    public function setAdditionalInfo(array $info)
    {
        ...
        $this->data['disbursements_acct'] = (!empty($info['disbursements_acct'])) ? $info['disbursements_acct'] : null;
